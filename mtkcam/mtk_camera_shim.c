...
void _ZN7android13SensorManagerC1Ev(void *sensorMgr)
{
    ...
    _ZN7android8String16C1EPKc(&string, "camera.mt6735");
...
{
    ALOGD("Sensor manager interposition library loaded");
}
...
{
    ALOGD("Sensor manager interposition library unloading. Goodbye...");
