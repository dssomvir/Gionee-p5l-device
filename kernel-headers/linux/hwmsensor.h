...
//Gionee BSP1 yang_yang modify for proximity gesture begin
#define SENSOR_TYPE_GESTURE				31
//Gionee BSP1 yang_yang modify for proximity gesture end
...
//Gionee BSP1 yang_yang modify for proximity gesture begin
#define ID_GESTURE						(ID_BASE+SENSOR_TYPE_GESTURE-1)
...
//Gionee BSP1 yang_yang modify for proximity gesture begin
#define SENSOR_GESTURE					(1 << ID_GESTURE) 
//Gionee BSP1 yang_yang modify for proximity gesture end
