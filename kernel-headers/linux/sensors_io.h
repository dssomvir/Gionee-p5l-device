...
// Gionee BSP chengx 20150325 add for sensorhub begin
#define ALSPS_SET_PS_CALI               _IOW(ALSPS, 0x17, int)
#define ALSPS_GET_PS_CALI               _IOR(ALSPS, 0x18, int)
#define ALSPS_GET_PS_NOISE              _IOR(ALSPS, 0x19, int)
// Gionee BSP chengx 20150325 add for sensorhub end
